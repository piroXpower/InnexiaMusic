...
@Client.on_message(contact_filter & filters.command(['end', 'stop', '/end', '/stop'], prefixes=f"{HNDLR}"))
...
@Client.on_message(contact_filter & filters.command(['pause', '/pause'], prefixes=f"{HNDLR}"))
...
@Client.on_message(contact_filter & filters.command(['resume', '/resume'], prefixes=f"{HNDLR}"))
