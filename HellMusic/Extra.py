...
@Client.on_message(contact_filter & filters.command(['ping', '/ping'], prefixes=f"{HNDLR}"))
...
@Client.on_message(contact_filter & filters.command(['restart', '/restart'], prefixes=f"{HNDLR}"))
...
@Client.on_message(contact_filter & filters.command(['help', '/help'], prefixes=f"{HNDLR}"))
